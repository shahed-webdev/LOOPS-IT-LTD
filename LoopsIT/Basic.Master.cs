...
namespace LoopsIT
{
    public partial class Basic : System.Web.UI.MasterPage
    {
        ...
        private DataTable GetData(string query)
        {
            ...
            string constr = ConfigurationManager.ConnectionStrings["LoopsITConnectionString"].ConnectionString;
        ...
        protected void AdminFormView_ItemUpdated(object sender, FormViewUpdatedEventArgs e)
        {
            ...
            FileUpload AdminFileUpload = (FileUpload)Ad_InfoFormView.FindControl("AdminFileUpload");

            //Member Image
            if (AdminFileUpload.PostedFile != null && AdminFileUpload.PostedFile.FileName != "")
            {
                string strExtension = System.IO.Path.GetExtension(AdminFileUpload.FileName);
                if ((strExtension.ToUpper() == ".JPG") | (strExtension.ToUpper() == ".PNG"))
                {
                    // Resize Image Before Uploading to DataBase
                    System.Drawing.Image imageToBeResized = System.Drawing.Image.FromStream(AdminFileUpload.PostedFile.InputStream);
                    ...
                    cmd.Parameters.AddWithValue("@RegistrationID", Ad_InfoFormView.DataKey["RegistrationID"].ToString());
