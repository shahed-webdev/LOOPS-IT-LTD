    ...
    public partial class Manage_Roles : System.Web.UI.Page
    {
        ...
        protected void RoleCheckBox_CheckChanged(object sender, EventArgs e)
        {
            ...
            if (RoleCheckBox.Checked)
            {
                ...
                Roles.AddUsersToRoles(selectedUserName, roleName);
            ...
            else
            {
                ...
                Roles.RemoveUsersFromRoles(selectedUserName, roleName);
        ...
        protected void RolesUserList_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string[] selectedRoleName = { RoleList.SelectedValue };// Get the selected role
            string[] UserName = { UserNameLabel.Text };

            // Remove the user from the role
            Roles.RemoveUsersFromRoles(UserName, selectedRoleName);
