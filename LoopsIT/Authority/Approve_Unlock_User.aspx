<%@ Page Title="" Language="C#" MasterPageFile="~/Design.Master" AutoEventWireup="true" CodeBehind="Approve_Unlock_User.aspx.cs" Inherits="LoopsIT.Authority.Approve_Unlock_User" %>
...
<div class="Contain">
    <p>
        <asp:HyperLink ID="BackLink" runat="server"
            NavigateUrl="~/AST/Manage_Users.aspx">&lt;&lt; Back to User List</asp:HyperLink>
    </p>
    <table>
        <tr>
